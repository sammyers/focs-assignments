...
__It just puts it on the next line.__

c. Does this algorithm produce an optimal result? (Do you have enough information to answer this question?)

__Not sure. Depends on how you want to handle words that overflow the character limit. I'd say probably not optimal.__
...
__Dynamic programming (bottom up)__
